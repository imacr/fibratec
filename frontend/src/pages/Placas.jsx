    ...
    return (
      <div className="unidades-container">
        ...
        <div className="filtros-container">
          ...
          <Select
            options={[{ value: "", label: "Todas las unidades" }, ...unidades.map(u => ({ value: u.id_unidad, label: `${u.cve} - ${u.marca} ${u.version}` }))]}
            value={filtroUnidadTabla !== "" ? { value: filtroUnidadTabla, label: unidades.find(u => u.id_unidad === filtroUnidadTabla) ? `${filtroUnidadTabla} - ${unidades.find(u => u.id_unidad === filtroUnidadTabla).cve} ${unidades.find(u => u.id_unidad === filtroUnidadTabla).marca} ${unidades.find(u => u.id_unidad === filtroUnidadTabla).version}` : filtroUnidadTabla } : { value: "", label: "Todas las unidades" }}
          ...
          <table className="elegant-table">
            ...
            <tbody>
              {placas.map(p => (
                <tr key={p.id_placa}>
                  <td>{p.id_placa}</td>
                  <td>{p.cve || "N/A"} {p.marca || "N/A"} {p.version || "N/A"} {p.modelo || "N/A"}</td>
                  <td>{p.placa}</td>
                  <td>{p.folio}</td>
